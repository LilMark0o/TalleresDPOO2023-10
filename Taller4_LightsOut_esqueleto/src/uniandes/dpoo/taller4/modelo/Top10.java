...
public class Top10 {
	 ...
	 * entrar o no al top-10 (conocer el �ltimo elementos de una Cola de P
	 * ioridades
	 * es O(n) )
	 */
	 ...
	 * @throws FileNotFoundException        Esta excepci�n se lanza si hay p
	 *                                      oblemas
	 *                                      creando el archivo
	...
	/**
	 * Carga la informaci�n de los records a partir de un archivo de texto que d
	 * be
	 ...
	 * - Cada registro tiene el nombre y los puntos separados por el caracter ';'
	 * 
	 * @param archivo El archivo donde se encuentra almacenada la informaci�n de l
	 *                s
